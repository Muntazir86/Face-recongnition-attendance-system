...
Button(root, text="Attendance Sheet", font=('times new roman', 20), bg="#0D47A1", fg="white").grid(
    row=6, columnspan=2, sticky=N + E + W + S, padx=5, pady=5)

Button(root, text="Developers", font=('times new roman', 20), bg="#0D47A1", fg="white", ).grid(row=8,
                                                                                                                columnspan=2,
                                                                                                                sticky=N + E + W + S,
                                                                                                                padx=5,
                                                                                                                pady=5)
